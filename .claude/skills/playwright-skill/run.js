...
// Use system Chromium when the expected downloaded binary is unavailable (network-restricted env)
...
if (fs.existsSync(SYSTEM_CHROMIUM)) {
  try {
    ...
    pw.chromium.launch = (opts = {}) => origLaunch({ executablePath: SYSTEM_CHROMIUM, ...opts });
  } catch (_) {}
}
